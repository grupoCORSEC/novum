...
<!-- <body onload="window.print();"> -->
    ...
    while($cTrabajo = $csCTrabajo->fetchArray()){
        ...
        <div/>
            ...
            <table style="font-size: .8em; width: 500px;">
                <tr>
            ...
            <table style="width: 500px;">
                <tr>
                    <td class="tSinBorde" style="width: 300px;">
                    <b>Prueba gráfica </b>
                    <div>
            ...
            <table style="font-size: .8em; width: 500px;">
                <tr>
                    <td style="width: 200px; text-align: center"><b> FACTORES PROPIOS DE LA ACTIVIDAD </b></td>
                    <td style="width: 90px; text-align: center"> Número de colaboradores </td>
                    <td style="width: 90px; text-align: center"> Porcentaje </td>
                </tr>
                <tr>
            ...
            <table style="font-size: .8em; width: 500px;">
                <tr>
                    <td style="width: 200px; text-align: center"><b> ORGANIZACIÓN DEL TIEMPO DE TRABAJO </b></td>
                    <td style="width: 90px; text-align: center"> Número de colaboradores </td>
                    <td style="width: 90px; text-align: center"> Porcentaje </td>
                </tr>
                <tr>
            ...
            <table style="font-size: .8em; width: 500px;">
                <tr>
                    <td style="width: 200px; text-align: center"><b> LIDERAZGO Y RELACIONES DE TRABAJO </b></td>
                    <td style="width: 90px; text-align: center"> Número de colaboradores </td>
                    <td style="width: 90px; text-align: center"> Porcentaje </td>
                </tr>
                <tr>
            ...
            <table style="font-size: .8em; width: 500px;">
                <tr>
                    <td style="width: 200px; text-align: center"><b> ENTORNO ORGANIZACIONAL </b></td>
                    <td style="width: 90px; text-align: center"> Número de colaboradores </td>
                    <td style="width: 90px; text-align: center"> Porcentaje </td>
                </tr>
                <tr>
    ...
    echo "
        ...
        var mixedChart = new Chart(ctx1, {
            type: 'doughnut',
            data: {
                labels: ['Muy alto', 'Alto', 'Medio', 'Bajo', 'Nulo o despreciable'],
                datasets: [{
                    label: 'Nose donde pone esto',
                    data: 1%,
                    backgroundColor: [
                        'rgba(155,229,247,1)',
                        'rgba(107,245,110,1)',
